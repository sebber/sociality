defmodule SocialityWeb.UserAuthTest do
  use SocialityWeb.ConnCase, async: true

  alias Sociality.Accounts
  alias SocialityWeb.UserAuth
  import Sociality.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SocialityWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SocialityWeb.Endpoint.subscribe(live_socket_id)
