defmodule SocialityWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SocialityWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/sociality_web/templates",
        namespace: SocialityWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SocialityWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import SocialityWeb.LiveHelpers
